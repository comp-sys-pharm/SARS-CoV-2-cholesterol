...
We generate a signaling prior knowledge network from OmniPath using OmniPath 
curated PPI interactions, pathway extra interactions and kinase extra 
interactions. 

```{r pkn1, eval=TRUE, warning=FALSE}
